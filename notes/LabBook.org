...
SL1
- [ ] Nome do orientador: adicionar o Mello entre Lucas e Schnorr
- [ ] Data: colocar a data inteira na última linha

SL3
- [ ] Colocar uma figura representativa com duas fases (do StarVZ)

SL4
- [ ] Informar que os logs de 18GB foram com execuções pequenas,
  envolvendo poucos nós computacionais

SL5
- [ ] Dar mais ênfase ao objetivo, por exemplo colocando ele de
  maneira centralizada e mais sintética

SL6
- [ ] Os textos da figura estão demasiadamente pequenos, aumentar a
  figura.

SL7
- [ ] Aumentar textos das figuras
- [ ] Explicar melhor o que é o sparklyr
  - Informar por exemplo que o código do StarVZ é modificado minimamente

SL8
- [ ] Texto sobre validação (último item) mover para SL11

SL10
- [ ] Colocar uma linha na parte inferior da tabela para fechá-la

SL11
- [ ] Dizer/Escrever qual o objetivo da validação antes de falar do método adotado
...
SL12
- [ ] Mudar título do slide removendo o termo "Arquitetura"
  - Colocar por exemplo "Projeto Experimental"
- [ ] Aumentar figura (veja quanto espaço em branco tem em volta)
...
- [ ] Ver comentários para o SL13 no contexto de SL14
