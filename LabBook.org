...
*** Capítulo 3 (StarVZ)
Último parágrafo
- [ ] Cuidar separação do sujeito do verbo tal qual em "Como na
...
4.1
- [ ] Há uma semelhança bastante grande entre Fig4.1 e Fig4.2. Talvez
  possa se ganhar em clareza removendo a Fig4.2.
- [ ] Na Figura 4.3, talvez fosse interessante especificar quais
  arquivos foram para o HDFS e quais não.
- [ ] No parágrafo iniciado por "A biblioteca escolhida ... sparklyr",
...
4.2
- [ ] Não fica claro no primeiro parágrafo o que é o "novo arquivo com
  o fluxo da exec. distribuída", nem o que é o "único pacote".
- [ ] Os parâmetros -S e -D são para qual script?
- [ ] Menção à Fig4.4 deve aparecer antes da figura. Utilize [!htb] no
  begin figure.
- [ ] Falas que a ordem de processamento não foi alterada, mas não
...
- [ ] Acredito que a Sec4.2 mereça um parágrafo inicial onde lista-se
...
- [ ] Cuidar o respeito à margens da página
- [ ] Cuidar emprego de vírgulas como aquela empregada na primeira
  frase do parágrafo que começa com "A última manipulação"
- [ ] Substituir o termo manipulação para transformação dado o
  significado potencialmente negativo de manipulação.
- [ ] "Durante o desenvolvimento, foi observada que a versão
