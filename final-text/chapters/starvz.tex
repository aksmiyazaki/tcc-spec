...
Há algum tempo, vivemos na era dos dados. A quantidade de dados armazenada em 
meios eletrônicos é dificil de medir, mas existem alguns estudos que podem nos 
auxiliar a ter uma noção disso. Uma estimativa da IDC (\textit{International 
Data Corporation}) \cite{ref:idcdigitaluniverse}, de acordo com o histórico de 
crescimento do mundo digital, este deve crescer entre 2013 e 2020 de 4.4 para 
44 zettabytes \footnote{Um zettabyte significa um trilhão de gigabytes.}.
