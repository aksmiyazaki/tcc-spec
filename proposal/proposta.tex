...
\begin{table}[H]
    \centering
    \begin{tabular}{|p{1.8in}|p{0.5in}|p{0.5in}|p{0.5in}|p{0.5in}|} \toprule 
Etapa & \multicolumn{4}{|p{2.0in}|}{Meses} \\ \bottomrule 
 & Mai & Jun & Jul & Ago  \\ \bottomrule 
Implementação & X & X &  &   \\ \bottomrule 
Experimentação &  & X & X &   \\ \bottomrule 
Pesquisa e Escrita & X & X & X & X  \\ \bottomrule 
