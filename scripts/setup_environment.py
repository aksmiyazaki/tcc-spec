...
#subprocess.run(["apt-get install default-jre"])
#default-jre, libxml2-dev, libssl-dev, libcurl4-openssl-dev e r-base
...
print('CONFIGURE MAPRED-SITE MEMORY STUFF')
print('CONFIGURE YARN-SITE MEMORY STUFF')
